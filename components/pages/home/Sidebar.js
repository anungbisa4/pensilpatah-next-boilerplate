  ...
  return (
    <>
      <Menu
        ...
        itemListClassName={
          "flex flex-col justify-between relative flex-1 px-3 outline-remove"
        }
        className={"bg-white outline-remove"}
      >
        <div className="outline-remove">
          <div className="flex items-center justify-between px-3 xs:pt-7">
            <img className="w-40 xs:w-200" src="/img/trvLogo.svg" alt="logo-trans"/>
            <button
          ...
          <div className="mt-8">
            <a className="group flex items-center justify-between py-2 mb-4 last:mb-0 px-3 hover:bg-blue-600 rounded-md transition-200">
              <div className="flex items-center">
                ...
                <h1 className="ml-3 xs:ml6 text-14px font-semibold group-hover:text-white">
                  VIP Access
                </h1>
              </div>
              <button
